...
ff = SeparableSum(prox_col[1]=>M1,prox_col[2]=>M2)
y,fy = prox(f,x,1.)
yy,fyy = prox(ff,x,1.)
...
f = SeparableSum([NormL1(1.),NormL21(0.1)],[1:10,11:20],2 )
#test second constructor
ff = SeparableSum(NormL1(1.)=> 1:10, NormL21(0.1)=> 11:20; dim =2 )
...
show(ff)
show(SeparableSum(repmat([NormL1(1.)],6),repmat([1:10],6),2 ))
